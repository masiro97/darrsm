...
class HarkSrcFeatureMFM {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.src.forEach((val) => {
      bufferOffset = HarkSrcFeatureMFMVal.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HarkSrcFeatureMFM(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.src[i] = HarkSrcFeatureMFMVal.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.src.forEach((val) => {
      length += HarkSrcFeatureMFMVal.getMessageSize(val);
    });
    return length + 12;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HarkSrcFeatureMFM(null);
    ...
    if (msg.src !== undefined) {
      ...
      for (let i = 0; i < resolved.src.length; ++i) {
        resolved.src[i] = HarkSrcFeatureMFMVal.Resolve(msg.src[i]);
      }
    }
    else {
      resolved.src = []
...
module.exports = HarkSrcFeatureMFM;
