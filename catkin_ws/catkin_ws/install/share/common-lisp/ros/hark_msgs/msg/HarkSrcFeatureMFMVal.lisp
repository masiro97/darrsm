...
(cl:defmethod azimuth-val ((m <HarkSrcFeatureMFMVal>))
...
(cl:defmethod elevation-val ((m <HarkSrcFeatureMFMVal>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HarkSrcFeatureMFMVal>)))
  ...
  "127ac60e264e1ad6ade4a918cf7daa0e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HarkSrcFeatureMFMVal)))
  "Returns md5sum for a message object of type 'HarkSrcFeatureMFMVal"
  "127ac60e264e1ad6ade4a918cf7daa0e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HarkSrcFeatureMFMVal>)))
  ...
  (cl:format cl:nil "int32 id~%float32 power~%float32 x~%float32 y~%float32 z~%float32 azimuth~%float32 elevation~%int32 length_feature~%int32 data_bytes_feature~%float32[] featuredata_feature~%int32 length_mfm~%int32 data_bytes_mfm~%float32[] featuredata_mfm~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HarkSrcFeatureMFMVal)))
  "Returns full string definition for message of type 'HarkSrcFeatureMFMVal"
  (cl:format cl:nil "int32 id~%float32 power~%float32 x~%float32 y~%float32 z~%float32 azimuth~%float32 elevation~%int32 length_feature~%int32 data_bytes_feature~%float32[] featuredata_feature~%int32 length_mfm~%int32 data_bytes_mfm~%float32[] featuredata_mfm~%~%~%"))
