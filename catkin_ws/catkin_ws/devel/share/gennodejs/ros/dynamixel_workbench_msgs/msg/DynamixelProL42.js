...
class DynamixelProL42 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DynamixelProL42(null);
  ...
  static datatype() {
    ...
    return 'dynamixel_workbench_msgs/DynamixelProL42';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '98b4472929fbc21dae60ac1636feb3f4';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DynamixelProL42(null);
...
module.exports = DynamixelProL42;
