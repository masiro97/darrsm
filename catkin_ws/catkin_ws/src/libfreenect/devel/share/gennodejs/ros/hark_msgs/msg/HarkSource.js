...
class HarkSource {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.src.forEach((val) => {
      bufferOffset = HarkSourceVal.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.src[i] = HarkSourceVal.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HarkSource(null);
    ...
    if (msg.src !== undefined) {
      ...
      for (let i = 0; i < resolved.src.length; ++i) {
        resolved.src[i] = HarkSourceVal.Resolve(msg.src[i]);
      }
    }
    else {
      resolved.src = []
