...
(cl:defclass <HarkSrcFeatureVal> (roslisp-msg-protocol:ros-message)
  ((id
    :reader id
    :initarg :id
    :type cl:integer
...
(cl:defclass HarkSrcFeatureVal (<HarkSrcFeatureVal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <HarkSrcFeatureVal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'HarkSrcFeatureVal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hark_msgs-msg:<HarkSrcFeatureVal> is deprecated: use hark_msgs-msg:HarkSrcFeatureVal instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod power-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod x-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod y-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod z-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod azimuth-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod elevation-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod length-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod data_bytes-val ((m <HarkSrcFeatureVal>))
...
(cl:defmethod featuredata-val ((m <HarkSrcFeatureVal>))
  ...
  (featuredata m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HarkSrcFeatureVal>) ostream)
  "Serializes a message object of type '<HarkSrcFeatureVal>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HarkSrcFeatureVal>) istream)
  "Deserializes a message object of type '<HarkSrcFeatureVal>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HarkSrcFeatureVal>)))
  "Returns string type for a message object of type '<HarkSrcFeatureVal>"
  "hark_msgs/HarkSrcFeatureVal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HarkSrcFeatureVal)))
  "Returns string type for a message object of type 'HarkSrcFeatureVal"
  "hark_msgs/HarkSrcFeatureVal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HarkSrcFeatureVal>)))
  "Returns md5sum for a message object of type '<HarkSrcFeatureVal>"
  "d113c763364c0f932a790285d83f9656")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HarkSrcFeatureVal)))
  "Returns md5sum for a message object of type 'HarkSrcFeatureVal"
  "d113c763364c0f932a790285d83f9656")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HarkSrcFeatureVal>)))
  "Returns full string definition for message of type '<HarkSrcFeatureVal>"
  (cl:format cl:nil "int32 id~%float32 power~%float32 x~%float32 y~%float32 z~%float32 azimuth~%float32 elevation~%int32 length~%int32 data_bytes~%float32[] featuredata~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HarkSrcFeatureVal)))
  "Returns full string definition for message of type 'HarkSrcFeatureVal"
  (cl:format cl:nil "int32 id~%float32 power~%float32 x~%float32 y~%float32 z~%float32 azimuth~%float32 elevation~%int32 length~%int32 data_bytes~%float32[] featuredata~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HarkSrcFeatureVal>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HarkSrcFeatureVal>))
  "Converts a ROS message object to a list"
  (cl:list 'HarkSrcFeatureVal
    (cl:cons ':id (id msg))
