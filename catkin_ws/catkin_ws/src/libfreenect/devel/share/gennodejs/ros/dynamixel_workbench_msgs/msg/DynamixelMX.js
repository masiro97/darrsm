...
class DynamixelMX {
  ...
  static datatype() {
    ...
    return 'dynamixel_workbench_msgs/DynamixelMX';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '9c83070bb7d2f8c4166fe16523f12aac';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DynamixelMX(null);
