...
;//! \htmlinclude DynamixelRX.msg.html

(cl:defclass <DynamixelRX> (roslisp-msg-protocol:ros-message)
  ((model_number
    :reader model_number
...
(cl:defclass DynamixelRX (<DynamixelRX>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <DynamixelRX>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'DynamixelRX)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_workbench_msgs-msg:<DynamixelRX> is deprecated: use dynamixel_workbench_msgs-msg:DynamixelRX instead.")))

(cl:ensure-generic-function 'model_number-val :lambda-list '(m))
(cl:defmethod model_number-val ((m <DynamixelRX>))
...
(cl:defmethod version_of_firmware-val ((m <DynamixelRX>))
...
(cl:defmethod id-val ((m <DynamixelRX>))
...
(cl:defmethod baud_rate-val ((m <DynamixelRX>))
...
(cl:defmethod return_delay_time-val ((m <DynamixelRX>))
...
(cl:defmethod cw_angle_limit-val ((m <DynamixelRX>))
...
(cl:defmethod ccw_angle_limit-val ((m <DynamixelRX>))
...
(cl:defmethod the_highest_limit_temperature-val ((m <DynamixelRX>))
...
(cl:defmethod the_lowest_limit_voltage-val ((m <DynamixelRX>))
...
(cl:defmethod the_highest_limit_voltage-val ((m <DynamixelRX>))
...
(cl:defmethod max_torque-val ((m <DynamixelRX>))
...
(cl:defmethod status_return_level-val ((m <DynamixelRX>))
...
(cl:defmethod alarm_led-val ((m <DynamixelRX>))
...
(cl:defmethod alarm_shutdown-val ((m <DynamixelRX>))
...
(cl:defmethod torque_enable-val ((m <DynamixelRX>))
...
(cl:defmethod led-val ((m <DynamixelRX>))
...
(cl:defmethod cw_compliance_margin-val ((m <DynamixelRX>))
...
(cl:defmethod ccw_compliance_margin-val ((m <DynamixelRX>))
...
(cl:defmethod cw_compliance_slope-val ((m <DynamixelRX>))
...
(cl:defmethod ccw_compliance_slope-val ((m <DynamixelRX>))
...
(cl:defmethod goal_position-val ((m <DynamixelRX>))
...
(cl:defmethod moving_speed-val ((m <DynamixelRX>))
...
(cl:defmethod torque_limit-val ((m <DynamixelRX>))
...
(cl:defmethod present_position-val ((m <DynamixelRX>))
...
(cl:defmethod present_velocity-val ((m <DynamixelRX>))
...
(cl:defmethod present_load-val ((m <DynamixelRX>))
...
(cl:defmethod present_voltage-val ((m <DynamixelRX>))
...
(cl:defmethod present_temperature-val ((m <DynamixelRX>))
...
(cl:defmethod registered-val ((m <DynamixelRX>))
...
(cl:defmethod moving-val ((m <DynamixelRX>))
...
(cl:defmethod lock-val ((m <DynamixelRX>))
...
(cl:defmethod punch-val ((m <DynamixelRX>))
  ...
  (punch m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DynamixelRX>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DynamixelRX>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DynamixelRX>)))
  "Returns string type for a message object of type '<DynamixelRX>"
  "dynamixel_workbench_msgs/DynamixelRX")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DynamixelRX)))
  "Returns string type for a message object of type 'DynamixelRX"
  "dynamixel_workbench_msgs/DynamixelRX")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DynamixelRX>)))
  "Returns md5sum for a message object of type '<DynamixelRX>"
  "5492318b88b3d8bc3fe76f394c6d263b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DynamixelRX)))
  "Returns md5sum for a message object of type 'DynamixelRX"
  "5492318b88b3d8bc3fe76f394c6d263b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DynamixelRX>)))
  "Returns full string definition for message of type '<DynamixelRX>"
  (cl:format cl:nil "# Published by dynamixel_workbench_single_manager and Subscribed by dynamixel_workbench_single_manager_gui~%# This message is compatible with control table of Dynamixel RX Series (RX-24F, RX-28, RX-64)~%# and it is linked to RX_42F.device, RX_28.device and RX_64.device in dynamixel_workbench_toolbox/dynamixel/RX folder~%# If you want to specific information about control table, please follow the link (http://support.robotis.com/en/)~%~%int64 model_number~%int64 version_of_firmware~%int8  id~%int64 baud_rate~%int64 return_delay_time~%int64 cw_angle_limit~%int64 ccw_angle_limit~%int64 the_highest_limit_temperature~%int64 the_lowest_limit_voltage~%int64 the_highest_limit_voltage~%int64 max_torque~%int64 status_return_level~%int64 alarm_led~%int64 alarm_shutdown~%bool  torque_enable~%bool led~%int64 cw_compliance_margin~%int64 ccw_compliance_margin~%int64 cw_compliance_slope~%int64 ccw_compliance_slope~%int64 goal_position~%int64 moving_speed~%int64 torque_limit~%int64 present_position~%int64 present_velocity~%int64 present_load~%int64 present_voltage~%int64 present_temperature~%bool registered~%bool moving~%bool lock~%int64 punch~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DynamixelRX)))
  "Returns full string definition for message of type 'DynamixelRX"
  (cl:format cl:nil "# Published by dynamixel_workbench_single_manager and Subscribed by dynamixel_workbench_single_manager_gui~%# This message is compatible with control table of Dynamixel RX Series (RX-24F, RX-28, RX-64)~%# and it is linked to RX_42F.device, RX_28.device and RX_64.device in dynamixel_workbench_toolbox/dynamixel/RX folder~%# If you want to specific information about control table, please follow the link (http://support.robotis.com/en/)~%~%int64 model_number~%int64 version_of_firmware~%int8  id~%int64 baud_rate~%int64 return_delay_time~%int64 cw_angle_limit~%int64 ccw_angle_limit~%int64 the_highest_limit_temperature~%int64 the_lowest_limit_voltage~%int64 the_highest_limit_voltage~%int64 max_torque~%int64 status_return_level~%int64 alarm_led~%int64 alarm_shutdown~%bool  torque_enable~%bool led~%int64 cw_compliance_margin~%int64 ccw_compliance_margin~%int64 cw_compliance_slope~%int64 ccw_compliance_slope~%int64 goal_position~%int64 moving_speed~%int64 torque_limit~%int64 present_position~%int64 present_velocity~%int64 present_load~%int64 present_voltage~%int64 present_temperature~%bool registered~%bool moving~%bool lock~%int64 punch~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <DynamixelRX>))
  (cl:+ 0
     8
     8
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DynamixelRX>))
