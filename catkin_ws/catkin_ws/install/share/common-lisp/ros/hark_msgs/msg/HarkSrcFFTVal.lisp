...
(cl:defmethod azimuth-val ((m <HarkSrcFFTVal>))
...
(cl:defmethod elevation-val ((m <HarkSrcFFTVal>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HarkSrcFFTVal>)))
  ...
  "94acf8949ad4989403dee204649029bc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HarkSrcFFTVal)))
  "Returns md5sum for a message object of type 'HarkSrcFFTVal"
  "94acf8949ad4989403dee204649029bc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HarkSrcFFTVal>)))
  ...
  (cl:format cl:nil "int32 id~%float32 power~%float32 x~%float32 y~%float32 z~%float32 azimuth~%float32 elevation~%int32 length~%float32[] fftdata_real~%float32[] fftdata_imag~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HarkSrcFFTVal)))
  "Returns full string definition for message of type 'HarkSrcFFTVal"
  (cl:format cl:nil "int32 id~%float32 power~%float32 x~%float32 y~%float32 z~%float32 azimuth~%float32 elevation~%int32 length~%float32[] fftdata_real~%float32[] fftdata_imag~%~%~%"))
