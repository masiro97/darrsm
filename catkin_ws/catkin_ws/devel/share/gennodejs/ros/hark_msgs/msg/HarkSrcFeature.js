...
class HarkSrcFeature {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.src.forEach((val) => {
      bufferOffset = HarkSrcFeatureVal.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HarkSrcFeature(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.src[i] = HarkSrcFeatureVal.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.src.forEach((val) => {
      length += HarkSrcFeatureVal.getMessageSize(val);
    });
    return length + 12;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HarkSrcFeature(null);
    ...
    if (msg.src !== undefined) {
      ...
      for (let i = 0; i < resolved.src.length; ++i) {
        resolved.src[i] = HarkSrcFeatureVal.Resolve(msg.src[i]);
      }
    }
    else {
      resolved.src = []
