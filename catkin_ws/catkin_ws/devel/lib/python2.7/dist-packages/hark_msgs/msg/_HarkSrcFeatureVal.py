...
class HarkSrcFeatureVal(genpy.Message):
  _md5sum = "d113c763364c0f932a790285d83f9656"
...
float32[] featuredata
"""
  __slots__ = ['id','power','x','y','z','azimuth','elevation','length','data_bytes','featuredata']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,power,x,y,z,azimuth,elevation,length,data_bytes,featuredata
