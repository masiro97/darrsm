...
class DynamixelMX64 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DynamixelMX64(null);
  ...
  static datatype() {
    ...
    return 'dynamixel_workbench_msgs/DynamixelMX64';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '0aecc698fc2b6f7ba1fae4a45202b0bf';
  }
  ...
  static messageDefinition() {
    ...
    # This message is compatible with control table of Dynamixel MX-64 Series (MX-64, MX-64AT/AR)
    # and it is linked to MX_64.device in dynamixel_workbench_toolbox/dynamixel/MX folder
  ...
  static Resolve(msg) {
    ...
    const resolved = new DynamixelMX64(null);
