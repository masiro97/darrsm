// Generated by gencpp from file dynamixel_workbench_msgs/DynamixelMX.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELMX_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELMX_H
...
struct DynamixelMX_
{
  typedef DynamixelMX_<ContainerAllocator> Type;
  ...
  DynamixelMX_(const ContainerAllocator& _alloc)
    : model_number(0)
    , version_of_firmware(0)
    , id(0)
    , baud_rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> const> ConstPtr;

}; // struct DynamixelMX_

typedef ::dynamixel_workbench_msgs::DynamixelMX_<std::allocator<void> > DynamixelMX;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX > DynamixelMXPtr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX const> DynamixelMXConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9c83070bb7d2f8c4ULL;
  static const uint64_t static_value2 = 0x166fe16523f12aacULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::DynamixelMX_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELMX_H
