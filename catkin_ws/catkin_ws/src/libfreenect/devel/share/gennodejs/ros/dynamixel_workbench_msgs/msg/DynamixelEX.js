...
class DynamixelEX {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int64(obj.sensed_current, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.sensed_current = _deserializer.int64(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'dynamixel_workbench_msgs/DynamixelEX';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'ae49dac55253508dbc88acad15a583c5';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DynamixelEX(null);
