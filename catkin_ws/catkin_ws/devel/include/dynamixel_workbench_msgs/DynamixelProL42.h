// Generated by gencpp from file dynamixel_workbench_msgs/DynamixelProL42.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELPROL42_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELPROL42_H
...
struct DynamixelProL42_
{
  typedef DynamixelProL42_<ContainerAllocator> Type;
  ...
  DynamixelProL42_(const ContainerAllocator& _alloc)
    : model_number(0)
    , version_of_firmware(0)
    , id(0)
    , baud_rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> const> ConstPtr;

}; // struct DynamixelProL42_

typedef ::dynamixel_workbench_msgs::DynamixelProL42_<std::allocator<void> > DynamixelProL42;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelProL42 > DynamixelProL42Ptr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelProL42 const> DynamixelProL42ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x98b4472929fbc21dULL;
  static const uint64_t static_value2 = 0xae60ac1636feb3f4ULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::DynamixelProL42_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELPROL42_H
