...
class HarkFeature {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.src.forEach((val) => {
      bufferOffset = HarkFeatureVal.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.src[i] = HarkFeatureVal.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.src.forEach((val) => {
      length += HarkFeatureVal.getMessageSize(val);
    });
    return length + 12;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HarkFeature(null);
    ...
    if (msg.src !== undefined) {
      ...
      for (let i = 0; i < resolved.src.length; ++i) {
        resolved.src[i] = HarkFeatureVal.Resolve(msg.src[i]);
      }
    }
    else {
      resolved.src = []
