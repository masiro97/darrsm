...
"""autogenerated by genpy from dynamixel_workbench_msgs/DynamixelAX.msg. Do not edit."""
import sys
...
class DynamixelAX(genpy.Message):
  _md5sum = "5492318b88b3d8bc3fe76f394c6d263b"
  _type = "dynamixel_workbench_msgs/DynamixelAX"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DynamixelAX, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.model_number, _x.version_of_firmware, _x.id, _x.baud_rate, _x.return_delay_time, _x.cw_angle_limit, _x.ccw_angle_limit, _x.the_highest_limit_temperature, _x.the_lowest_limit_voltage, _x.the_highest_limit_voltage, _x.max_torque, _x.status_return_level, _x.alarm_led, _x.alarm_shutdown, _x.torque_enable, _x.led, _x.cw_compliance_margin, _x.ccw_compliance_margin, _x.cw_compliance_slope, _x.ccw_compliance_slope, _x.goal_position, _x.moving_speed, _x.torque_limit, _x.present_position, _x.present_velocity, _x.present_load, _x.present_voltage, _x.present_temperature, _x.registered, _x.moving, _x.lock, _x.punch,) = _get_struct_2qb11q2B12q3Bq().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2qb11q2B12q3Bq = None
def _get_struct_2qb11q2B12q3Bq():
    global _struct_2qb11q2B12q3Bq
    if _struct_2qb11q2B12q3Bq is None:
        _struct_2qb11q2B12q3Bq = struct.Struct("<2qb11q2B12q3Bq")
    return _struct_2qb11q2B12q3Bq
