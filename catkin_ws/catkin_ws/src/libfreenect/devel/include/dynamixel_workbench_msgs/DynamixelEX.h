// Generated by gencpp from file dynamixel_workbench_msgs/DynamixelEX.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELEX_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELEX_H
...
struct DynamixelEX_
{
  typedef DynamixelEX_<ContainerAllocator> Type;
  ...
  DynamixelEX_(const ContainerAllocator& _alloc)
    : model_number(0)
    , version_of_firmware(0)
    , id(0)
    , baud_rate(0)
  ...
  _punch_type punch;
   ...
   typedef int64_t _sensed_current_type;
  _sensed_current_type sensed_current;




  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> const> ConstPtr;

}; // struct DynamixelEX_

typedef ::dynamixel_workbench_msgs::DynamixelEX_<std::allocator<void> > DynamixelEX;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelEX > DynamixelEXPtr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelEX const> DynamixelEXConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xae49dac55253508dULL;
  static const uint64_t static_value2 = 0xbc88acad15a583c5ULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::DynamixelEX_<ContainerAllocator>& v)
  {
    ...
    Printer<int64_t>::stream(s, indent + "  ", v.sensed_current);
  }
};
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELEX_H
