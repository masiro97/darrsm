// Generated by gencpp from file dynamixel_workbench_msgs/DynamixelMX64.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELMX64_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELMX64_H
...
struct DynamixelMX64_
{
  typedef DynamixelMX64_<ContainerAllocator> Type;
  ...
  DynamixelMX64_(const ContainerAllocator& _alloc)
    : model_number(0)
    , version_of_firmware(0)
    , id(0)
    , baud_rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> const> ConstPtr;

}; // struct DynamixelMX64_

typedef ::dynamixel_workbench_msgs::DynamixelMX64_<std::allocator<void> > DynamixelMX64;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX64 > DynamixelMX64Ptr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelMX64 const> DynamixelMX64ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0aecc698fc2b6f7bULL;
  static const uint64_t static_value2 = 0xa1fae4a45202b0bfULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::DynamixelMX64_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELMX64_H
