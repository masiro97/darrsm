...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_workbench_toolbox_SOURCE_PREFIX /home/cun/catkin_ws/src/dynamixel-workbench/dynamixel_workbench_toolbox)
  set(dynamixel_workbench_toolbox_DEVEL_PREFIX /home/cun/catkin_ws/src/libfreenect/devel)
  ...
  set(dynamixel_workbench_toolbox_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/cun/catkin_ws/src/dynamixel-workbench/dynamixel_workbench_toolbox/include " STREQUAL " ")
  set(dynamixel_workbench_toolbox_INCLUDE_DIRS "")
  set(_include_dirs "/home/cun/catkin_ws/src/dynamixel-workbench/dynamixel_workbench_toolbox/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dynamixel_workbench_toolbox' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dynamixel_workbench_toolbox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cun/catkin_ws/src/dynamixel-workbench/dynamixel_workbench_toolbox/${idir}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
    endif()
