...
"""autogenerated by genpy from dynamixel_workbench_msgs/DynamixelMX64.msg. Do not edit."""
import sys
...
class DynamixelMX64(genpy.Message):
  _md5sum = "0aecc698fc2b6f7ba1fae4a45202b0bf"
  _type = "dynamixel_workbench_msgs/DynamixelMX64"
...
"""
  __slots__ = ['model_number','version_of_firmware','id','baud_rate','return_delay_time','cw_angle_limit','ccw_angle_limit','the_highest_limit_temperature','the_lowest_limit_voltage','the_highest_limit_voltage','max_torque','status_return_level','alarm_led','alarm_shutdown','multi_turn_offset','resolution_divider','torque_enable','led','d_gain','i_gain','p_gain','goal_position','moving_speed','torque_limit','present_position','present_velocity','present_load','present_voltage','present_temperature','registered','moving','lock','punch','current','torque_control_mode_enable','goal_torque','goal_acceleration']
  _slot_types = ['int64','int64','int8','int64','int64','int64','int64','int64','int64','int64','int64','int64','int64','int64','int64','int64','bool','bool','int64','int64','int64','int64','int64','int64','int64','int64','int64','int64','int64','bool','bool','bool','int64','int64','bool','int64','int64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DynamixelMX64, self).__init__(*args, **kwds)
      ...
      if self.torque_control_mode_enable is None:
        self.torque_control_mode_enable = False
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.model_number, _x.version_of_firmware, _x.id, _x.baud_rate, _x.return_delay_time, _x.cw_angle_limit, _x.ccw_angle_limit, _x.the_highest_limit_temperature, _x.the_lowest_limit_voltage, _x.the_highest_limit_voltage, _x.max_torque, _x.status_return_level, _x.alarm_led, _x.alarm_shutdown, _x.multi_turn_offset, _x.resolution_divider, _x.torque_enable, _x.led, _x.d_gain, _x.i_gain, _x.p_gain, _x.goal_position, _x.moving_speed, _x.torque_limit, _x.present_position, _x.present_velocity, _x.present_load, _x.present_voltage, _x.present_temperature, _x.registered, _x.moving, _x.lock, _x.punch, _x.current, _x.torque_control_mode_enable, _x.goal_torque, _x.goal_acceleration,) = _get_struct_2qb13q2B11q3B2qB2q().unpack(str[start:end])
      ...
      self.torque_control_mode_enable = bool(self.torque_control_mode_enable)
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2qb13q2B11q3B2qB2q = None
def _get_struct_2qb13q2B11q3B2qB2q():
    global _struct_2qb13q2B11q3B2qB2q
    if _struct_2qb13q2B11q3B2qB2q is None:
        _struct_2qb13q2B11q3B2qB2q = struct.Struct("<2qb13q2B11q3B2qB2q")
    return _struct_2qb13q2B11q3B2qB2q
