// Generated by gencpp from file dynamixel_workbench_msgs/DynamixelRX.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELRX_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELRX_H
...
struct DynamixelRX_
{
  typedef DynamixelRX_<ContainerAllocator> Type;
  ...
  DynamixelRX_(const ContainerAllocator& _alloc)
    : model_number(0)
    , version_of_firmware(0)
    , id(0)
    , baud_rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> const> ConstPtr;

}; // struct DynamixelRX_

typedef ::dynamixel_workbench_msgs::DynamixelRX_<std::allocator<void> > DynamixelRX;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelRX > DynamixelRXPtr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::DynamixelRX const> DynamixelRXConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5492318b88b3d8bcULL;
  static const uint64_t static_value2 = 0x3fe76f394c6d263bULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::DynamixelRX_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_DYNAMIXELRX_H
