  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.src:
        ...
        buff.write(_get_struct_i().pack(val1.classid))
        _x = val1.phone
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_f().pack(val1.cm))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.classid,) = _get_struct_i().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        (val1.cm,) = _get_struct_f().unpack(str[start:end])
